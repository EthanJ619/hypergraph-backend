...
import com.cqupt.medical.hypergraph.entity.*;
import com.cqupt.medical.hypergraph.mapper.AdminDataManageMapper;
import com.cqupt.medical.hypergraph.mapper.UserMapper;
import com.cqupt.medical.hypergraph.service.AdminDataManageService;
...
public class AdminDataManageServiceImpl extends ServiceImpl<AdminDataManageMapper, AdminDataManage>
    ...
    public List<String> uploadDataTable(MultipartFile file, String pid, String tableName, String userName,
                                        ...
                                        String current_uid) throws IOException, ParseException, CsvException {
        // 封住表描述信息
