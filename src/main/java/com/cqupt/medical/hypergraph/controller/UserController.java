...
import com.cqupt.medical.hypergraph.util.SecurityUtil;
import com.cqupt.medical.hypergraph.vo.InsertUserVo;
import com.cqupt.medical.hypergraph.vo.UpdateStatusVo;
import com.cqupt.medical.hypergraph.vo.UserPwd;
import com.cqupt.medical.hypergraph.vo.VerifyUserQ;
...
//       userLogService.save(userLog);
    ...
    @PostMapping("/login")
    public Result login(@RequestBody User user, HttpServletResponse response, HttpServletRequest request) throws UnsupportedEncodingException {
