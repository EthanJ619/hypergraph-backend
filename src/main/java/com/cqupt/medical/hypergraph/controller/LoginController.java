...
import com.cqupt.medical.hypergraph.vo.MYRequest;
...
public class LoginController {
    ...
    public Result login(@RequestParam String repKey) throws URISyntaxException, IOException {
        ...
        // 请求地址 拿到key
//        String url1 = "http://192.168.1.39/API/BIAServicesToSSO.asmx/QueryKey?";   //互慧
        String url1 = "http://10.66.66.212:8084/API/BIAServicesToSSO.asmx/QueryKey?";  //绵阳三院
